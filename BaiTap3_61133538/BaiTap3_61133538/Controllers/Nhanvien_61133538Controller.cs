...
using BaiTap3_61133538.Models;

namespace BaiTap3_61133538.Controllers
{
    public class Nhanvien_61133538Controller : Controller
    {
        // GET: Nhanvien_61133538
        ...
        [HttpPost]
        public ActionResult Detaill(HttpPostedFileBase Avatar, EmpModel emp)
        {
